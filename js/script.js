...
const exit_btn = info_container.querySelector(".buttons .quit");
...
const res_container = document.querySelector(".res_container");
...
const restart_quiz = res_container.querySelector(".buttons .restart");
const quit_quiz = res_container.querySelector(".buttons .quit");

restart_quiz.onclick = () => {
	quiz_container.classList.add("activeQuiz");
	res_container.classList.remove("activeResult");
	timeValue = 15;
	que_count = 0;
	que_numb = 1;
	userScore = 0;
...
function showResult() {
	info_container.classList.remove("activeInfo");
	quiz_container.classList.remove("activeQuiz");
	res_container.classList.add("activeResult");
	const scoreText = res_container.querySelector(".score_text");
	if (userScore > 11) {
		let scoreTag =
